          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-3xl font-bold text-white tracking-tight">Travel Assistant</h1>
                <Sparkles className="w-5 h-5 text-yellow-300 animate-pulse" />
              </div>
              <p className="text-sm text-white/80 font-medium">Your AI-Powered Travel Companion</p>
            </div>
          </div>
        ...
        {showInfo && (
          <div className="mt-6 p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 animate-in slide-in-from-top duration-300">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-semibold text-white text-lg">How to use Travel Assistant</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-yellow-300 mt-1 flex-shrink-0" />
                <p className="text-sm text-white/90">Ask any travel-related question</p>
              </div>
              <div className="flex items-start gap-2">
                <Sparkles className="w-4 h-4 text-yellow-300 mt-1 flex-shrink-0" />
                <p className="text-sm text-white/90">Get instant AI-powered answers</p>
              </div>
              <div className="flex items-start gap-2">
